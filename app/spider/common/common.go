...
import (
	...
	"github.com/molast/crawler-core/common/mahonia"
	"github.com/molast/crawler-core/common/ping"
)
...
// SplitCookies cookies字符串转[]*http.Cookie，（如"mt=ci%3D-1_0; thw=cn; sec=5572dc7c40ce07d4e8c67e4879a; v=0;"）
...
// UnicodeToUTF8 将"&#21654;&#21857;&#33394;&#124;&#32511;&#33394;"转为"咖啡色|绿色"
...
// Unicode16ToUTF8 将`{"area":[["quanguo","\u5168\u56fd\u8054\u9500"]]｝`转为`{"area":[["quanguo","全国联销"]]｝`
...
// MakeUrl @SchemeAndHost https://www.baidu.com
// @path /search?w=x
...
// ProcessHtml 处理html文件--add by lyken 20160512
...
// DepriveBreak 清除换行--add by lyken 20160512
...
// DepriveMutiBreak 多余的换行--add by lyken 20160819
...
// HrefSub 在原有网址上添加参数--add by lyken 20160901
...
// GetHerf 网址组合--add by lyken 20160512
