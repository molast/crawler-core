...
import (
	...
	"github.com/molast/crawler-core/app/aid/history"
...
// TryFlushSuccess 非服务器模式下保存历史成功记录
...
// TryFlushFailure 非服务器模式下保存历史失败记录
